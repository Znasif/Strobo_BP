...
public class SRanipalEye : ModuleRules
{
	public SRanipalEye(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateIncludePaths.AddRange(
			new string[] {
                Path.GetFullPath(Path.Combine(ModuleDirectory, ".."))+"/SRanipalEye/Private",
