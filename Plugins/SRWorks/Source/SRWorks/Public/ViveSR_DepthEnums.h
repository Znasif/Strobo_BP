    ...
    namespace Depth
    {
        ...
        */
        enum InputMask
        {
            ...
            _CAMERA_PARAMS = 18,             // sizeof(dualcamera::DeviceInfo)
        ...
        enum InputMask4K
        {
            _DISTORTED_4K_FRAME_LEFT = 0,	// sizeof(char) * 1920 * 1920 * 4
            _DISTORTED_4K_FRAME_RIGHT = 1,	// sizeof(char) * 1920 * 1920 * 4
            _UNDISTORTED_4K_FRAME_LEFT = 2,
            _UNDISTORTED_4K_FRAME_RIGHT = 3,	// sizeof(char) * 2424 * 2424 * 4
            _FRAME_SEQ_4K = 4,
            _TIME_STP_4K = 5,			// sizeof(unsigned int)
            _POSE_LEFT_4K = 6,			// sizeof(float) * 16
            _POSE_RIGHT_4K = 7,		// sizeof(float) * 16
            _LUX_LEFT_4K = 8,			// sizeof(int)
            _LUX_RIGHT_4K = 9,			// sizeof(int)
            _COLOR_TEMPERATURE_LEFT_4K = 10,	// sizeof(int)
            _COLOR_TEMPERATURE_RIGHT_4K = 11,	// sizeof(int)
            _CAMERA_PARAMS_4K = 12,	// sizeof(char) * 1032
            _D3D11_TEXTURE2D_SHARED_HANDLE_LEFT_4K = 13, // sizeof(void *)
            _D3D11_TEXTURE2D_SHARED_HANDLE_RIGHT_4K = 14,	// sizeof(void *)
            _D3D11_TEXTURE2D_BUFFER_INDEX_4K = 15,	// sizeof(unsigned int)
            INPUT_MASK_MAX_4K,
        };
        /**
        ...
        */
        enum OutputMask
        {
            ...
            CAMERA_PARAMS = 10,             // sizeof(dualcamera::DeviceInfo)
            OUTPUT_MASK_MAX,
        };
